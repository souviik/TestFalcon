...
public class EbayHomePage {
    ...
    // Load locators from properties file with fallbacks
    ...
    private By cartCount = By.cssSelector(PropertiesHelpers.getValue("cart_count"));
    private By categoryDropdown = By.cssSelector(PropertiesHelpers.getValue("category_dropdown"));
    ...
    private By cartIconAlt = By.cssSelector("a[href*='cart']");
    ...
    public EbaySearchResultsPage clickSearchButton() {
        ...
        // Try multiple locators for search button
    ...
    public void verifyPageLoaded() {
        ...
        // Wait for eBay logo with fallback (optional - less critical)
        ...
        // Verify at least search bar is present (core functionality)
        if (!searchBarFound) {
