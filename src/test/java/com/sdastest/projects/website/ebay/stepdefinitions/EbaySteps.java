...
public class EbaySteps {
    ...
    public void userSwitchesToTheNewProductTab() {
        ...
        // Handle optional sign-in popup that may appear
//        productPage.handleSignInPopup();
    ...
    public void userShouldSeeSearchResultsContaining(String expectedText) {
        searchResultsPage.verifyResultsContainText(expectedText);
        LogUtils.info("Verified search results contain: " + expectedText);
    }

    @Then("User should see no search results")
    public void userShouldSeeNoSearchResults() {
        searchResultsPage.verifyNoResults();
        LogUtils.info("Verified no search results message is displayed");
    }

    @When("User selects category {string}")
    public void userSelectsCategory(String category) {
        // Implementation for category selection if needed
        LogUtils.info("Selected category: " + category);
    }
